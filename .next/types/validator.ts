...
// Validate ../../src/app/api/webhooks/entrata/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/webhooks/entrata">> = Specific
  const handler = {} as typeof import("../../src/app/api/webhooks/entrata/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
